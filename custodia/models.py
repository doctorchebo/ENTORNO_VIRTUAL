...
from django.db.models.fields import BigAutoField, BigIntegerField, CharField, DateField, DateTimeField, IntegerField, NullBooleanField, TextField
...
class Desembolsos(models.Model):
    ...
    class Meta:
        permissions = [
            ('borrar_desembolso','Puede borrar desembolsos')
        ]
    ...
    usuario_creacion = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_creacion_desembolso')
    usuario_modificacion = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_modificacion_desembolso')
...
class Distribucion(models.Model):
    ...
    tipo = models.ForeignKey(TipoOperacion, on_delete=models.SET_NULL, blank=True, null=True)
    analista_asignado = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='distribuido_a')
    usuario_creacion = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_creacion_distribucion')
    usuario_modificacion = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_modificacion_distribucion')
...
class Correspondencia(models.Model):
    ...
    contenido = models.CharField(max_length=100, blank=True, null=True,choices= CONTENIDO)
    ...
    usuario_registro = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True, related_name='usuario_envio_correspondencia')
    usuario_recepcion = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True,related_name='usuario_recepcion_correspondencia')
    history = AuditlogHistoryField()
...
class DocumentosSueltos(models.Model):
    ...
    sobre = models.ForeignKey(Correspondencia, on_delete=models.SET_NULL, blank=True, null=True)
    sucursal = models.CharField(max_length=50, blank=True, null=True)
    agencia = models.CharField(max_length=50, blank=True, null=True)
    ...
    bloque = models.PositiveBigIntegerField(null=True)
    caja = models.PositiveBigIntegerField(null=True)
    estado = models.CharField(max_length=20,blank=True,null=True, choices = ESTADO)
    usuario_creacion = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True,null=True,related_name='usuario_creacion_documento_suelto')
    usuario_modificacion = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True,null=True,related_name='usuario_modificacion_documento_suelto')
    fecha_creacion = models.DateTimeField(auto_now_add=True, blank =True, null = True)
    fecha_modificacion = models.DateTimeField(auto_now= True, blank =True, null = True)
    history = AuditlogHistoryField()
    def __str__(self) -> str:
...
class Contratos(models.Model):
    ...
    cantidad_minuta = models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_minuta = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    ...
    cantidad_testimonio = models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_testimonio = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    contrato_privado = models.BooleanField(default=False,blank=True)
    cantidad_contrato = models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_contrato = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    ...
    cantidad_rec_firmas = models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_rec_firmas = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    cert_tdr = models.BooleanField(default=False,blank=True)
    cantidad_cert_tdr = models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_cert_tdr = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    cert_desgravamen = models.BooleanField(default=False,blank=True)
    cantidad_cert_desgravamen= models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_cert_desgravamen = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    seguro_cesantia = models.BooleanField(default=False,blank=True)
    cantidad_seguro_cesantia= models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_seguro_cesantia = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    seguro_dima = models.BooleanField(default=False,blank=True)
    cantidad_seguro_dima= models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_seguro_dima = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    anexos_seguros = models.BooleanField(default=False,blank=True)
    cert_gravamen = models.BooleanField(default=False,blank=True)
    cantidad_cert_gravamen = models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_cert_gravamen  = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    ...
    cantidad_cert_fundempresa = models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_cert_fundempresa  = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    ...
    cantidad_folio = models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_folio  = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    ...
    cantidad_inf_rapido= models.CharField(max_length=1,blank=True,null=True,choices=CANTIDAD)
    estado_inf_rapido  = models.ForeignKey(FormatoContrato, on_delete = models.SET_NULL, max_length=50,blank=True,null=True, related_name='+')
    ...
    estado = models.CharField(max_length=20, blank=True,null=True, choices=ESTADO_CONTRATO)
    conformidad = models.BooleanField(blank=True, default=False)
    ubicacion = models.CharField(max_length=100,blank=True,null=True)
    usuario_modificacion_legal = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_mod_contrato_legal')
    usuario_modificacion_empate = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_mod_contrato_empate')
    usuario_creacion = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_creacion_contrato')
    fecha_creacion = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    fecha_modificacion = models.DateTimeField(auto_now=True, blank=True, null=True)
    history = AuditlogHistoryField()
    def __str__(self) -> str:
...
class Inmueble(models.Model):
    ...
    fecha_creacion = models.DateTimeField(auto_now_add=True)
    fecha_modificacion = models.DateTimeField(auto_now=True)
    usuario_creacion = models.ForeignKey(Profile,on_delete=models.SET_NULL,blank=True,null=True, related_name='usuario_creacion_inmueble')
    usuario_modificacion = models.ForeignKey(Profile,on_delete=models.SET_NULL,blank=True,null=True, related_name='usuario_modificacion_inmueble')
    history = AuditlogHistoryField()
...
class Vehiculo(models.Model):
    ...
    formulario_registro_vehicular = models.CharField(max_length=100,blank=True,null=True)
    ...
    fecha_creacion = models.DateTimeField(auto_now_add=True)
    fecha_modificacion = models.DateTimeField(auto_now=True)
    usuario_creacion = models.ForeignKey(Profile,on_delete=models.SET_NULL,blank=True,null=True, related_name='usuario_creacion_vehiculo')
    usuario_modificacion = models.ForeignKey(Profile,on_delete=models.SET_NULL,blank=True,null=True, related_name='usuario_modificacion_vehiculo')
    history = AuditlogHistoryField()
...
class Empate(models.Model):
    ...
    # INFORMACIÓN BÁSICA
    distribucion = models.ForeignKey(Distribucion, on_delete=models.SET_NULL,blank=True,null=True)
    estado = models.CharField(max_length=20,blank=True,null=True, choices = ESTADO)
    tipo_operacion = models.CharField(max_length=50, choices = TIPO,blank=True,null=True)
    ...
    respaldos_ingresos = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    autorizacion_investigacion = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    cic_cod_con_ext = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    cic_cod_sin_ext = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    cic_hist_con_ext = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    cic_hist_sin_ext = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    ...
    hoja_riesgos = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    lista_confidencial = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    atencion_preferente = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    retenciones_judiciales = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    cliente_pleno_oportuno_pago = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    segip = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    carnet_identidad = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    cic_cod_con_ext_desembolso = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    cic_cod_sin_ext_desembolso = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    cic_nombre_desembolso = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    bi_codigo_desembolso = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    bi_nombre_desembolso = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    plan_pagos = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    nota_credito = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    formulario_solicitud = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    verif_domiciliaria = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    verif_laboral = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    ddjj_bienes = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    copia_boleta_garantia=models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    solicitud_seguro_desgravamen = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    solicitud_seguro_cesantia = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    solicitud_seguro_dima = models.CharField(max_length=5,choices=FORMATO,blank=True,null=True)
    ...
    usuario_empate = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_empate')
    empatado = models.BooleanField(default=False, blank=True)
    tiempo_empate = models.DecimalField(max_digits=10, decimal_places=1, blank=True, null =True)
    history = AuditlogHistoryField()
...
class SubCategoriaObservacion(models.Model):
    nombre = models.CharField(max_length=50,blank=True, null=True)
    categoria = models.ForeignKey(CategoriaObservacion, on_delete=models.SET_NULL, blank=True, null=True)
    def __str__(self):
        return f'{self.nombre}'

class ItemObservacion(models.Model):
    nombre = models.CharField(max_length=50,blank=True, null=True)
    sub_categoria = models.ForeignKey(SubCategoriaObservacion, on_delete=models.SET_NULL, blank=True, null=True)
    def __str__(self):
        return f'{self.nombre}'
...
class Observaciones(models.Model):
    ...
    categoria=models.ForeignKey(CategoriaObservacion,null=True,on_delete=models.SET_NULL)
    sub_categoria=models.ForeignKey(SubCategoriaObservacion,null=True,on_delete=models.SET_NULL)  
    observacion=models.ForeignKey(ItemObservacion,null=True,on_delete=models.SET_NULL)
    ...
    usuario_observacion = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_observacion')
    usuario_revision=models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_revision')
    history = AuditlogHistoryField()
    def __str__(self):
...
class Levantamientos(models.Model):
    ...
    codigo_cliente = models.PositiveBigIntegerField(blank=True, null=True)
    ...
    analista = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_levantamientos')
    solicitante = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_solicitante')
    fecha_entrega = models.DateField(blank=True, null=True)
    enviado_a = models.ForeignKey(Profile, on_delete = models.SET_NULL, blank=True, null=True)
    fecha_devolucion = models.DateTimeField(blank=True, null=True)
    estado = models.CharField(max_length=100, blank=True, null=True, choices = ESTADO)
    observaciones = models.CharField(max_length=255, blank=True, null=True)
    caja = models.PositiveBigIntegerField(blank =True, null=True)
    carpeta = models.PositiveBigIntegerField(blank=True, null=True)
    fecha_creacion = models.DateTimeField(auto_now_add=True, blank = True, null = True)
    fecha_modificacion = models.DateTimeField(auto_now=True, blank = True, null = True)
    usuario_creacion = models.ForeignKey(Profile, on_delete = models.SET_NULL, blank=True, null=True, related_name='usuario_creacion_levantamiento')
    usuario_modificacion = models.ForeignKey(Profile, on_delete = models.SET_NULL, blank=True, null=True, related_name='usuario_modificacion_levantamiento')
    enviado_por = models.ForeignKey(Profile, on_delete=models.SET_NULL,blank=True,null=True,related_name='usuario_levantamientos_formulario')
    history = AuditlogHistoryField()
...
class Sobre(models.Model):
    ...
    fecha_creacion = models.DateTimeField(auto_now_add=True)
    fecha_modificacion = models.DateTimeField(auto_now=True)
    usuario_creacion = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True, related_name = "usuario_modificacion_sobre")
    usuario_modificacion = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True, related_name = "usuario_creacion_sobre")
    history = AuditlogHistoryField()
...
class Prestamo(models.Model):
    ...
    estado = models.CharField(max_length=100,blank=True, null = True, choices=ESTADO)    
    custodio = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True)
    notas = models.TextField(max_length=500,blank=True, null=True )   
    fecha_creacion = models.DateTimeField(auto_now_add=True)
    fecha_modificacion = models.DateTimeField(auto_now=True)
    usuario_solicitante = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True,related_name = 'usuario_prestamo')
    usuario_custodio = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True,related_name = 'usuario_custodio')
    history = AuditlogHistoryField()
...
class Apertura(models.Model):
    ...
    saldo_captacion = models.DecimalField(max_digits=20,decimal_places=2, blank=True,null=True)
    estado = models.CharField(max_length=15, blank=True, null=True, choices= ESTADO)
    fecha_creacion = models.DateTimeField(auto_now_add=True,blank=True, null=True )
    fecha_modificacion = models.DateTimeField(auto_now=True,blank=True, null=True)
    usuario_creacion = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True,related_name = 'usuario_creacion_apertura')
    usuario_modificacion = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True,related_name = 'usuario_modificacion_apertura')
    caja = models.BigIntegerField(null=True)
    bloque = models.PositiveBigIntegerField(null=True)
    history = AuditlogHistoryField()
...
class Poliza(models.Model):
    ...
    caja = models.BigIntegerField(null=True)
    bloque = models.PositiveBigIntegerField(null=True)
    usuario_creacion=models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True, related_name = 'usuario_creacion_poliza')
    usuario_modificacion=models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True,related_name = 'usuario_modificacion_poliza')
    history = AuditlogHistoryField()
...
class Tarea(models.Model):
    ...
    analista_asignado = models.ForeignKey(Profile, blank=True, null=True, on_delete=models.SET_NULL)
    descripcion = models.CharField(max_length=255, blank=True, null=True)
    estado = models.CharField(max_length=100, blank=True, null=True, choices = ESTADO)
    fecha_creacion =models.DateTimeField(auto_now_add=True)
    fecha_modificacion = models.DateTimeField(auto_now=True)
    usuario_creacion = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True,related_name = 'usuario_creacion_tarea')
    usuario_modificacion = models.ForeignKey(Profile, on_delete=models.SET_NULL, blank=True, null=True,related_name = 'usuario_modificacion_tarea')
    history = AuditlogHistoryField()
